...
We tested our program on a computer with an Intel(R) Core(TM) i7-8700K CPU @ 3.70GHz and $2 \times 8$ GiB DDR4 DIMM @ 2133 MHz in dual channel mode.
...
In each dataset category of DOTmark and each grid dimension from $32 \times 32$ to $128 \times 128$, we pair every two datasets and solve the corresponding discrete optimal transport on grids instance ten times.
